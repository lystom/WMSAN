...
def site_effect(z, f, vs_crust, path, zlat, zlon):
                ...
                for ih in HOUR:
                    ...
                    if save == True:
                        ...
                        try:
                            ...
                            print('path %s does not exist, creating it'%path_out)
                            try:
                                os.makedirs(path_out)
                            except:
                                print('cannot create path %s'%path_out)
...
def spectrogram(path_netcdf, dates, lon_sta=-21.3268, lat_sta=64.7474, Q=200, U=1800):
    ...
    plt.pcolormesh(dates, freq, spectro.T)
    plt.xlabel('Date ')
